...
void update(UniTensor& ALa, UniTensor& BLb, map<Qnum, Matrix>& La, map<Qnum, Matrix>& Lb, const UniTensor& U, Network& iTEBD, Network& updateA);
...
void update(UniTensor& ALa, UniTensor& BLb, map<Qnum, Matrix>& La, map<Qnum, Matrix>& Lb, const UniTensor& expH, Network& iTEBD, Network& updateA){
